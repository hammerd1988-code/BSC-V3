...
export default class SSHClient {
    ...
    */
     ...
     */
    static connectWithKey(host: string, port: number, username: string, privateKey: string, passphrase?: string, options?: HostKeyOptions, callback?: CallbackFunction<HostKeyInfo>): Promise<SSHClient>;
    static connectWithKey(host: string, port: number, username: string, privateKey: string, passphrase?: string, callback?: CallbackFunction<HostKeyInfo>): Promise<SSHClient>;
    /**
     ...
     */
    static connectWithPassword(host: string, port: number, username: string, password: string, options?: HostKeyOptions, callback?: CallbackFunction<HostKeyInfo>): Promise<SSHClient>;
    static connectWithPassword(host: string, port: number, username: string, password: string, callback?: CallbackFunction<HostKeyInfo>): Promise<SSHClient>;
    private _key;
    private _listeners;
    private _counters;
     ...
     * @returns A promise that resolves with the response from the server.
     */
    startShell(ptyType: PtyType, options?: ShellOptions, callback?: CallbackFunction<string>): Promise<string>;
