    ...
    function: {
      ...
      parameters: {
        ...
        properties: {
          ...
          private_key_path: { type: 'string', description: 'Path to a PEM-encoded private key file. Must be inside the working directory or ~/.ssh. Not required if password or private_key is provided.' },
          ...
          local_path: { type: 'string', description: 'Local file path for SFTP operations. Must be inside the working directory.' },
