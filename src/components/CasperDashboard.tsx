          ...
          <div className="grid gap-6">
            ...
            <div className="grid gap-6 xl:grid-cols-[0.95fr_1.05fr]">
              ...
              <GlassPanel>
                ...
                <div className="mt-4 grid gap-3 sm:grid-cols-2">{Object.entries(config.obligations).map(([key, value]) => <React.Fragment key={key}><TogglePill active={Boolean(value)} label={key.replace(/_/g, ' ')} onClick={() => void saveConfig({ ...config, obligations: { ...config.obligations, [key]: !Boolean(value) } as ScheduleConfig['obligations'] })} /></React.Fragment>)}</div>
              </GlassPanel>
            </div>
            ...
            <div className="grid gap-6 xl:grid-cols-[1.2fr_0.8fr]">
              ...
              <div className="grid gap-6">
                ...
                <GlassPanel>
                  ...
                  <div className="grid gap-3">{Object.entries(config.capabilities).map(([key, value]) => <React.Fragment key={key}><TogglePill active={Boolean(value)} label={key.replace(/_/g, ' ')} onClick={() => void saveConfig({ ...config, capabilities: { ...config.capabilities, [key]: !Boolean(value) } as ScheduleConfig['capabilities'] })} /></React.Fragment>)}</div>
                </GlassPanel>
              </div>
            </div>
          </div>
